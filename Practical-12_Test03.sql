...
EXEC InsertIntoEmployee @FirstName='Khush',@MiddleName=NUll,@LastName='Patel',@DOB='1999-02-02' ,@MobileNumber='156462656',@Address='akjsadnidw',@Salary=500,@DesignationId='1';
